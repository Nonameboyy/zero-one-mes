	...
	<el-container>
		<el-header>
			<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal">
				...
				<el-menu-item index="2">工序设置</el-menu-item>
			</el-menu>
		</el-header>
			...
			<el-row :gutter="20" style="margin-top: 20px">
				<el-col :span="24">
					...
					>
						...
						<el-table-column prop="code" label="工序编码" width="480" />
						<el-table-column prop="name" label="工序名称" width="480" />
						<el-table-column prop="enabled" label="是否启用" width="480" />
...
export default {
	...
	data() {
		return {
			...
			currentPage: 1,
			tableData: [
				{ code: "WS0707", name: "组装1号站", enabled: "是", note: "--" },
				{ code: "WS0720", name: "151541515", enabled: "是", note: "--" },
				{ code: "WS0734", name: "111", enabled: "是", note: "1-111" },
				{ code: "WS0802", name: "包娟", enabled: "是", note: "--" },
				{ code: "WS0831", name: "AGV接驳", enabled: "是", note: "--" },
				{ code: "WS0835", name: "宣家机架中心", enabled: "是", note: "--" },
			],
			selectedRows: [],
