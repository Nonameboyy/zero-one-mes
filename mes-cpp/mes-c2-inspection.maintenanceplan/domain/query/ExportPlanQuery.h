...
*/
#ifndef _EXPORTPLANQUERY_H_
#define _EXPORTPLANQUERY_H_
...
class ExportPlanQuery : public oatpp::DTO
{
	DTO_INIT(ExportPlanQuery, DTO)
	
	API_DTO_FIELD_DEFAULT(String, plan_code, 
