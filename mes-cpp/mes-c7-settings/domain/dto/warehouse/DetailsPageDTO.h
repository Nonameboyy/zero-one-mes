...
*/
#ifndef _DETAILSPAGE_DTO_
#define  _DETAILSPAGE_DTO_
...
class DetailsDTO : public oatpp::DTO
{
...
class DetailsPageDTO :public PageDTO<DetailsDTO::Wrapper> {
	DTO_INIT(DetailsPageDTO, PageDTO<DetailsDTO::Wrapper>);
};
