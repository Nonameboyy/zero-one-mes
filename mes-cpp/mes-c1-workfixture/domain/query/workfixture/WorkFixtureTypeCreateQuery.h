...
*/
#ifndef _CREATEQUERY_H_
#define _CREATEQUERY_H_
...
/**
 * 工装夹具/类型设置/获取工装夹具类型名称列表  增加
 */
class WorkFixtureTypeCreateQuery : public oatpp::DTO
{
	DTO_INIT(WorkFixtureTypeCreateQuery, DTO);
	//唯一标识
	...
	API_DTO_FIELD(String, maintenType, ZH_WORDS_GETTER("workfixture.type.fields.type"), true, "NULL");
	//保养周期
	API_DTO_FIELD(Int32, maintenPriod, ZH_WORDS_GETTER("workfixture.type.fields.mapriod"), true, 0);
	//备注
	API_DTO_FIELD(String, remark, ZH_WORDS_GETTER("workfixture.type.fields.remark"), true, "");
};

#include OATPP_CODEGEN_END(DTO)
#endif // !_CREATEQUERY_H_