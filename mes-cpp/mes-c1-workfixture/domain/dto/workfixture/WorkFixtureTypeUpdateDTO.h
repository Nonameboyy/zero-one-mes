...
*/
#ifndef _UPDATEDTO_H_
#define _UPDATEDTO_H_
 ...
 * 工装夹具/类型设置 改
 */
class WorkFixtureTypeUpdateDTO : public oatpp::DTO
{
	DTO_INIT(WorkFixtureTypeUpdateDTO, DTO);
	//唯一标识
	...
	//保养周期
	//API_DTO_FIELD(Int32, maintenPeriod, ZH_WORDS_GETTER("workfixture.type.fields.mapriod"), true, 0);
	//备注
