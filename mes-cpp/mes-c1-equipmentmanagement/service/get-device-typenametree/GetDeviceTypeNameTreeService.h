...
#ifndef _GETDEVICETYPETREE_SERVICE_H_
#define _GETDEVICETYPETREE_SERVICE_H_
...
class GetDeviceTypeNameTreeService
{
public:
	// 通过类型名称查询名称树
	list<EquipmentTypeDO> queryTypeNameTree(const string &name);
};
