...
#ifndef _GETDEVICETYPE_DAO_H_
#define _GETDEVICETYPE_DAO_H_
#include "stdafx.h"
...
class GetDeviceTypeDetailDAO : public BaseDAO
{
public:
	// 通过类型名称查询数据
	list<EquipmentTypeDO> selectByCondition(const GetDeviceTypeDetailQuery::Wrapper& query);
};
#endif 
